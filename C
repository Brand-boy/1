...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
        ps1 = raw_input("Password ⋗⋗ \033[1;95m")
        ps2 = raw_input("Password ⋗⋗ \033[1;95m")
        ps3 = raw_input("Password ⋗⋗ \033[1;95m")
        ps4 = raw_input("Password ⋗⋗ \033[1;95m")
        ps5 = raw_input("Password ⋗⋗ \033[1;95m")
        ps6 = raw_input("Password ⋗⋗ \033[1;95m")
	...
	p.map(main, id)
	print 42*"\033[1;96m="
	print"\033[1;96m\033[1;97m[\033[1;92m+\033[1;97m] \033[1;92mTotal OK \033[1;97m[\033[1;92m+\033[1;97m]Total CP \033[1;91m: \033[1;92m"+str(len(oks))+"\033[1;97m/\033[1;93m"+str(len(cps))
